...
kevin-kb-run --level 1 --problem-id 1 --technique puct_search --puct-total-rollouts 128 --puct-init-rollouts 16 --puct-steps-per-rollout 4 --puct-exploration-coeff 1.0 --puct-parallel-rollouts 8 --temperature 0.9 --modal-gpu L40S --modal-timeout-s 120 --cache-results
```
